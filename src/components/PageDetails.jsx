                        ...
                        <Container className="justify-content-center mx-auto">
                            ...
                            <Row className="mb-5">
                                <Col >
                                    ...
                                    <h6>Codigo: {data.sku}</h6>
                                   <a href={data.img} target="_blank"> <Button type="button" id="watch" className="bg-dark   p-2 ">
                                       &#x25BA; Watch
                                    </Button></a>
                                    <Button className="bg-danger p-2 m-2" onClick={() => onAddToCart(data)} >Agregar al carrito</Button>
