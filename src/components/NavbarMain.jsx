      ...
      <div className="container d-flex justify-content-between align-items-center">
        ...
        <div className="align-self-center collapse navbar-collapse flex-fill justify-content-between"
          ...
          <div className="navbar align-self-center d-flex ">
            ...
            <div>
              <a className="nav-icon d-inline position-relative text-decoration-none" href="#?"
            ...
            {currentUser ? (
              ...
              <div className="">
                <NavLink to="/login" className="btn-success btn-login btn btn-outline-primary me-2">
                  Iniciar Sesión
                </NavLink>
              </div>
            )}
